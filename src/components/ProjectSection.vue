<template>
    <div class="w-full h-full text-left text-info">
        <div class="projectSection_image w-full aspect-[4/3] mb-2 shadow hover:scale-[1.02] duration-300">
            <RouterLink :to="dataC.path" class="block w-full h-full bg-cover"
